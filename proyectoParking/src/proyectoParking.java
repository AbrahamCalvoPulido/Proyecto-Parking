...
public class proyectoParking {
    ...
    public static void main(String[] args) {
        ...
        int codigoTicket,multasAnuladas=0,totalMultas=0,anioDelPago,horaDelPago,minDelPago,horaFinEstablecimiento=0,diaFinEstablecimiento=0,mesFinEstablecimiento=0,minFinEstablecimiento = 0,numAux,numAleatorio,longitudTicket,codigoMulta,codigoMulta2,opcionAdmin = 4,opcionMultas,segundosAux = 0,cantidadTickets=0,segundosPagados = 0,minutosPagados = 0,horasPagados = 0;
                    ...
                    if (intentosLog == 0) {
                        ...
                        switch (opcionAdmin) {
                            case 1:
                                ...
                                System.out.println();
                                System.out.println("CANTIDAD DE TICKETS GENERADOS SON:"+cantidadTickets);
                                break;
                            case 2:
